...
- [jQuery Exercises](#jquery-exercises)
  - [ Exercise 01 - DOM](#-exercise-01---dom)
  - [ Exercise 02 - Fetch](#-exercise-02---fetch)

## <a id="ex01"></a> Exercise 01 - DOM

Take in user input and output that data back to the output elements in the DOM. This exercise has been completed in JavaScript; use jQuery to rewrite the solution for this exercise.
...
Fetch all books from the API of Ice and Fire and append them to the DOM. This exercise has been completed in JavaScript; use jQuery to rewrite the solution for this exercise; Use jQuery to rewrite the solution to this exercise. You will need to make the HTTP request, create elements in the DOM, append elements, and style those elements.
